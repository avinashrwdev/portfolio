  ...
  return(
    ...
    >
      <section className="bg-white max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm-max-w-[50%] flex flex-col h-full sm:group-odd:mr-[18rem] sm:group-even:ml-[18rem]">
        ...
        <Image className="absolute hidden sm:block top-8 group-even:-left-28 -right-28 rounded-l-lg shadow-2xl 
          transition 
          group-hover:scale-0-[1.04] 
